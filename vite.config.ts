...
// =============================================================================
// Manus Debug Collector - Vite Plugin (mantido para compatibilidade)
// =============================================================================
...
export default defineConfig({
  ...
  // 🎯 REMOVIDO: root: "client/" (causava conflito de paths no Vercel)
  
  build: {
    // 🎯 CAMINHO SIMPLES E DIRETO: relativo ao projeto root
    outDir: "dist/public",
    emptyOutDir: true,
  },
